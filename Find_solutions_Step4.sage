...
def good_norms(p): #Lists congruence conditions for norms of elems with trace 0. See Explanation for good norms below.
    ...
    if p == 3: #x = (1/2*t + w)*i + (-u)*j + 1/2*t*k => Nx = 3*u^2 + w^2 + w*t + t^2 => Nx = w^2 + w*t + t^2 = 0, 1 (mod 3) 
        ...
        goodnorms = [R(0), R(1), R(2), R(4), R(5), R(8), R(9), R(10), R(11), R(16), R(17), R(18), R(19), R(20), R(21), R(22), R(25), R(29), R(31), R(32), R(34), R(36), R(37), R(38), R(39), R(40), R(42), R(43), R(44), R(45), R(47), R(49), R(50), R(55), R(58), R(59), R(62), R(64), R(68), R(69), R(72), R(74), R(76), R(78), R(80), R(81), R(84), R(85), R(86), R(88), R(90), R(91), R(94), R(95), R(97), R(98), R(99), R(100), R(103), R(105), R(110), R(116), R(118), R(121), R(123), R(124), R(125), R(127), R(128), R(136), R(137), R(138), R(139), R(144), R(145), R(148)]
    elif p == 863:
