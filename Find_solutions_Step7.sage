...
# CMfield1A13B50C49 with indices: 1 in K + , 7 in K (best A, best indices). bad: p7O1, p11O1, p11O2. potentially good: p19O1, p19O2.
if CMfieldnumber == 1:
    A = 13; B = 50; C = 49
# CMfield3A5B6C1 with indices: 1 in K + , 1 in K (best A, best indices). bad: p3O1.
if CMfieldnumber == 2:
    A = 6; B = 9; C = 1
# CMfield3A5B6C1 with indices: 1 in K + , 1 in K (best indices). bad: p3O1.
if CMfieldnumber == 22: 
    A = 9; B = 6; C = 1
# CMfield3A5B6C1 with indices: 1 in K + , 1 in K (best A, best indices). potentially good: p7O1.
if CMfieldnumber == 3:
    A = 5; B = 6; C = 1 
# CMfield3A6B5C1 with indices: 1 in K + , 1 in K (best indices). potentially good: p7O1.
if CMfieldnumber == 33:
    A = 6; B = 5; C = 1 
